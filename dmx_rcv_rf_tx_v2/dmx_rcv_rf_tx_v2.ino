...
int motor_1_pin = 3; // 9 no va
int led_1_pin = 10;
int motor_2_pin = 5; // 10 no va
int led_2_pin = 6;
int motor_3_pin = 11;
int led_3_pin = 6;
...
void rw_channels() {
  ...
  analogWrite(motor_1_pin, map( chn_1, 0, 255, 255, 0 )); // 0 en el motor es movimiento maximo
  analogWrite( led_1_pin, chn_1 );
  analogWrite( motor_2_pin, map( chn_2, 0, 255, 255, 0 ));
  analogWrite( led_2_pin, chn_2 );
  analogWrite( motor_3_pin, map( chn_3, 0, 255, 255, 0 ) );
  analogWrite( led_3_pin, chn_3 );
